...
vanguard_index_fund = Asset.create(portfolio_id: retirement_portfolio.id, symbol: "VTSAX", name: "Vanguard Total Stock Market Index Fund Admiral Shares", quantity: 100, market_price: nil, )
...
Asset.create(portfolio_id: retirement_portfolio.id, symbol: "BTC", name: "Bitcoin", quantity: 100, market_price: nil, asset_type: "crypto")